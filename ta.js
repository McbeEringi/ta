self.TA={
	...
	editor(w){TA.sizer(w);w.addEventListener('keydown',(e,{selectionStart:S,selectionEnd:E,value:V}=w,DP,P=_=>e.preventDefault(DP=1),I=(x,y,z=y)=>(x&&(w.value=V.slice(0,S)+x+V.slice(E)),w.selectionStart=y,w.selectionEnd=z),D=_=>S==E&&(TA.brkt.includes(V.slice(S-1,S+1))||(V[S-1]==V[S]&&TA.brkt.includes(V[S])))&&I(0,S-1,E+1))=>e.isComposing||(
		(({
